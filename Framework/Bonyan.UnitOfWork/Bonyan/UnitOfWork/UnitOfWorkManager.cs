...
public class UnitOfWorkManager : IUnitOfWorkManager
{
    ...
    public IUnitOfWork Begin(BonyanUnitOfWorkOptions options, bool requiresNew = false)
    {
    ...
    public void BeginReserved(string reservationName, BonyanUnitOfWorkOptions options)
    {
    ...
    public bool TryBeginReserved(string reservationName, BonyanUnitOfWorkOptions options)
    {
        Check.NotNull(reservationName, nameof(reservationName));
