...
public class UnitOfWork : IUnitOfWork
{
    ...
    public IBonyanUnitOfWorkOptions Options { get; private set; } = default!;
    ...
    private readonly BonyanUnitOfWorkDefaultOptions _defaultOptions;
    ...
    public UnitOfWork(
        ...
        IOptions<BonyanUnitOfWorkDefaultOptions> options)
    {
    ...
    public virtual void Initialize(BonyanUnitOfWorkOptions options)
    {
