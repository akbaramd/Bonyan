...
/// </summary>
public abstract class BonValueObject : IEquatable<BonValueObject>
{
    /// <summary>
    ...
    public bool Equals(BonValueObject? other)
    {
    ...
    public override bool Equals(object? obj)
    {
        ...
        return Equals(obj as BonValueObject);
    }
    ...
    public static bool operator ==(BonValueObject? left, BonValueObject? right)
    {
    ...
    public BonValueObject Clone()
    {
        return (BonValueObject)MemberwiseClone();
    }
    ...
    public static ValueComparer<T> GetValueComparer<T>() where T : BonValueObject
    {
