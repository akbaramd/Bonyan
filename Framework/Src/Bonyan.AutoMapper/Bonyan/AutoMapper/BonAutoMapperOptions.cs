...
public class BonAutoMapperOptions
{
  public List<Action<IBonAutoMapperConfigurationContext>> Configurators { get; }

  public ITypeList<Profile> ValidatingProfiles { get; set; }

  public BonAutoMapperOptions()
  {
    Configurators = new List<Action<IBonAutoMapperConfigurationContext>>();
