...
{
    /// <summary>
    /// Implementation of <see cref="IBonLayServiceProviderConfigurator"/> for managing and accessing services within a lazy-loaded service provider context.
    /// </summary>
    public class BonLayServiceProviderConfigurator : IBonLayServiceProviderConfigurator
    {
        /// <summary>
