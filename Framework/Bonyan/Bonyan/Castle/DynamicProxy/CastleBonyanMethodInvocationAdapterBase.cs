...
public abstract class CastleBonyanMethodInvocationAdapterBase : IBonyanMethodInvocation
{
    ...
    protected CastleBonyanMethodInvocationAdapterBase(IInvocation invocation)
    {
