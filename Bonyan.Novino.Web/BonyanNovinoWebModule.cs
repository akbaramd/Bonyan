...
public class BonyanNovinoWebModule : BonWebModule
{
    ...
    {
        DependOn<BonUiNovinoModule<Models.User, Models.Role>>();
        DependOn<BonAspNetCoreMvcModule>();
        DependOn<BonIdentityManagementEntityFrameworkCoreModule<Models.User, Models.Role>>();
    ...
    public override Task OnConfigureAsync(BonConfigurationContext context)
    {
        ...
        context.AddDbContext<AppDbContext>(c =>
        {
