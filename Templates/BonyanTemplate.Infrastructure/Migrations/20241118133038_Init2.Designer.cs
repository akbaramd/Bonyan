...
namespace BonyanTemplate.Infrastructure.Migrations
{
    ...
    [Migration("20241118133038_Init2")]
    partial class Init2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bonyan.UserManagement.Domain.Users.Enumerations.UserStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("BonyanTemplate.Domain.Users.User", b =>
                {
                    b.HasOne("Bonyan.UserManagement.Domain.Users.Enumerations.UserStatus", "Status")
                        .WithMany()
