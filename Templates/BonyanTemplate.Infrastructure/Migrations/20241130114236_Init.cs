    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BonIdentityRoleId = table.Column<string>(type: "TEXT", nullable: false),
                    PermissionsKey = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissions", x => new { x.BonIdentityRoleId, x.PermissionsKey });
                    table.ForeignKey(
