...
BEGIN
    CREATE TABLE [UserRoles] (
        ...
        CONSTRAINT [FK_UserRoles_Users_UserId1] FOREIGN KEY ([UserId1]) REFERENCES [Users] ([Id])
    );
END;
GO
...
BEGIN
    CREATE TABLE [UserTokens] (
        ...
        CONSTRAINT [FK_UserTokens_Users_UserId1] FOREIGN KEY ([UserId1]) REFERENCES [Users] ([Id])
    );
END;
GO
...
BEGIN
    CREATE INDEX [IX_UserRoles_UserId1] ON [UserRoles] ([UserId1]);
END;
GO
...
BEGIN
    CREATE INDEX [IX_UserTokens_UserId1] ON [UserTokens] ([UserId1]);
END;
GO
...
BEGIN
    ...
    VALUES (N'20250715093525_InitialCreate', N'8.0.12');
END;
GO
