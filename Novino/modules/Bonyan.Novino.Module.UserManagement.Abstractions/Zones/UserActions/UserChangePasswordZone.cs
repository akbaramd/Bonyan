...
/// <summary>
/// Zone model for user change password functionality
...
/// </summary>
public class UserChangePasswordZone : IZone
{
    public string ZoneId => "user_change_password";
    public string ZoneName => "UserManagementUserChangePassword";
    public IDictionary<string, object>? Metadata { get; set; } = new Dictionary<string, object>();

    /// <summary>
    /// User ID - the only essential data needed by change password components
    /// </summary>
