...
/// <summary>
/// Zone model for user lock/unlock functionality
...
/// </summary>
public class UserLockZone : IZone
{
    public string ZoneId => "user_lock";
    public string ZoneName => "UserManagementUserLock";
    public IDictionary<string, object>? Metadata { get; set; } = new Dictionary<string, object>();

    /// <summary>
    /// User ID - the only essential data needed by lock/unlock components
    /// </summary>
